...
public class EntityFox extends EntityTameable
{
    ...
    {
        return this.isAngry() ? "triniumrpg:foxangry" : (this.rand.nextInt(3) == 0 ? (this.isTamed() && this.dataWatcher.getWatchableObjectFloat(18) < 10.0F ? "mob.wolf.whine" : "mob.wolf.panting") : "mob.wolf.bark");
    }
    ...
    public boolean canMateWith(EntityAnimal par1EntityAnimal)
    {
        ...
        {
            EntityFox entitywolf = (EntityFox)par1EntityAnimal;
